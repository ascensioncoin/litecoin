...
Output from `gbuild` will look something like
    ...
    From https://github.com/ascension-project/ascension
...
For example:
```bash
URL=https://github.com/thrasher-/ascension.git
...
BTCPATH=/some/root/path/ascension
SIGPATH=/some/root/path/ascension-detached-sigs

./bin/gbuild --url ascension=${BTCPATH},signature=${SIGPATH} ../ascension/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
[gitian.sigs.ltc](https://github.com/ascension-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
