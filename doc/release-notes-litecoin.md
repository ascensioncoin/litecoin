Ascension Core version 0.13.3 is now available from:

  <https://download.ascension.org/ascension-0.13.3/>
...
Ascension Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in Ascension Core 0.10.4) it has been disabled by default.
...
- http://testnet.ascensiontools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/ascension-project/ascension/blob/0.13/src/chainparams.cpp#L214).
