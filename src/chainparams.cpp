...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.ascension.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("ascensiontools.com", "dnsseed.ascensiontools.com"));
        vSeeds.push_back(CDNSSeedData("ascensionpool.org", "dnsseed.ascensionpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("ascensiontools.com", "testnet-seed.ascensiontools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.ascension.loshan.co.uk", true));
